...
public class DatabaseConstants {
    ...
    * Database Queries
    ...
    public static final String USER_LOOKUP_ID_USERNAME_BY_USERNAME = "SELECT "
            ...
            + "FROM users "
            + "WHERE username = ?";
    public static final String LOOKUP_PHONE_NUMBER_QUERY = "SELECT " + DatabaseConstants.COLUMN_USER_PHONE + " FROM " + DatabaseConstants.TABLE_USERS + " WHERE " + DatabaseConstants.COLUMN_USER_ID + " = ?";
    public static final String LOOKUP_EVENTS_FOR_DATE_QUERY = "SELECT " + DatabaseConstants.COLUMN_EVENT_ID + ", " + DatabaseConstants.COLUMN_EVENT_NAME + ", " + DatabaseConstants.COLUMN_EVENT_DATE + ", " + DatabaseConstants.COLUMN_EVENT_PARENT + ", " + DatabaseConstants.COLUMN_IS_EVENT_PARENT + " FROM " + DatabaseConstants.TABLE_EVENTS +
            " WHERE " + DatabaseConstants.COLUMN_USER_ID + " = ? AND " + DatabaseConstants.COLUMN_EVENT_DATE + " >= ? AND " + DatabaseConstants.COLUMN_EVENT_DATE + " < ?";



    public static final String LOOKUP_UPCOMING_EVENTS_QUERY = "SELECT " + DatabaseConstants.COLUMN_EVENT_ID + ", " + DatabaseConstants.COLUMN_EVENT_NAME + ", " + DatabaseConstants.COLUMN_EVENT_DATE + ", " + DatabaseConstants.COLUMN_EVENT_PARENT + ", " + DatabaseConstants.COLUMN_IS_EVENT_PARENT +
            " FROM " + DatabaseConstants.TABLE_EVENTS +
            " WHERE " + DatabaseConstants.COLUMN_USER_ID + " = ? AND " + DatabaseConstants.COLUMN_EVENT_DATE + " >= ?" +
            " ORDER BY " + DatabaseConstants.COLUMN_EVENT_DATE + " ASC LIMIT ?";
